...
namespace Application.UseCases.V1.Task.GetListSearchTask;

public class GetListSearchTaskUseCase : IGetListSearchTaskUseCase
{
    private IOutputPortWithNotFound<GenericPaginationResponse<Domain.Entities.Task>> _outputPort;
    private ITaskRepository _repository;
    private readonly NotificationHelper _notificationHelper;

    public GetListSearchTaskUseCase(
    ...
    {
        var genericPaginationResponse = new GenericPaginationResponse<Domain.Entities.Task>();
            ...
            genericSearchPaginationRequest.ListaRelacionamento.Any())
        {
            ...
            {
                if (relational.Item1.ToUpper() == SystemConst.FieldProjectId.ToUpper())
                    query = query.Where(c => c.ProjectId == relational.Item2);
